...
def __init_prog_tracker(prog_event_handler, prog_delay):
    ...
    progresstracker = progress.RADProgressTracker(
        prog_event_handler=prog_event_handler, term_delay=prog_delay
    )
...
def rad_pkg(
    ...
    try:
        ret_json = entry._pkg_invoke(
            ...
            prog_tracker=rad_prog_tracker,
        )
        return ret_json
    except Exception as ex:
        if not ret_json:
            ret_json = {
                "status": UNANTICIPATED,
                "errors": [{"reason": str(ex)}],
            }
        return ret_json
...
class PkgPublisher:
    ...
    client_UUID = property(get_any("_client_UUID"), set_any("_client_UUID"))
    cat_updated_time = property(
        get_any("_cat_updated_time"), set_any("_cat_updated_time")
    )
    ...
    approved_CAs = property(get_any("_approved_CAs"), set_any("_approved_CAs"))
    revoked_CAs = property(get_any("_revoked_CAs"), set_any("_revoked_CAs"))
...
class PkgSource:
    ...
    cert_effective_date = property(
        get_any("_cert_effective_date"), set_any("_cert_effective_date")
    )
    cert_expiration_date = property(
        get_any("_cert_expiration_date"), set_any("_cert_expiration_date")
    )
...
class PkgInfo:
    ...
    description = property(get_any("_description"), set_any("_description"))
    ...
    last_install_time = property(
        get_any("_last_install_time"), set_any("_last_install_time")
    )
    last_update_time = property(
        get_any("_last_update_time"), set_any("_last_update_time")
    )
...
class PkgImage:
    ...
    image_path = property(
        get_any("_PkgImage__image_path"), set_any("_PkgImage__image_path")
    )
    ...
    def __fork_pkg_cmd(self, subcommand, pargs_json=None, opts_json=None):
        try:
            ...
            args.extend(["--prog-delay", str(self.__progress_interval)])
            ...
            while True:
                ...
                if out_line:
                    ...
                    if "phase" in out_json:
                        self._prog_event_handler(out_json)
            ...
            if not actualret:
                return {
                    "status": ERROR,
                    "errors": [{"reason": "no result collected in fork mode."}],
                }
            return actualret
        except Exception as ex:
            return {"status": ERROR, "errors": [{"reason": str(ex)}]}

    def __pkg(self, subcommand, pargs_json=None, opts_json=None, mode=None):
        """Perform pkg operation.
        ...
        if fork_exec:
            return self.__fork_pkg_cmd(
                subcommand, pargs_json=pargs_json, opts_json=opts_json
            )
        ...
        try:
            ...
            return {
                "status": UNANTICIPATED,
                "errors": [{"reason": traceback.format_exc()}],
            }
    ...
    def __handle_error(self, out_json):
        try:
            ...
            out_json = {
                "status": ERROR,
                "errors": [
                    {"reason": "invalid JSON output: {0}".format(out_json)}
                ],
            }
    ...
    def list_packages(
        self,
        pkg_fmri_patterns=None,
        refresh_catalogs=None,
        origins=None,
        list_installed_newest=None,
        list_all=None,
        list_newest=None,
        list_upgradable=None,
        mode=None,
    ):
        ...
        ret_json = self.__pkg(
            "list", pargs_json=pkg_fmri_patterns, opts_json=opts_json, mode=mode
        )
    ...
    def install(
        ...
        parsable_version=None,
        origins=None,
        li_erecurse_all=None,
        li_erecurse_list=None,
        li_erecurse_excl=None,
        sync_act=None,
        act_timeout=None,
        mode=None,
    ):
    ...
    def info(
        ...
        opts_json = self.__convert_opts2json(
            display_license=license_only,
            info_local=info_local,
            info_remote=info_remote,
            origins=origins,
        )
        ret_json = self.__pkg(
            "info", pargs_json=pkg_fmri_patterns, opts_json=opts_json, mode=mode
        )
        return self.__handle_error(ret_json)
    ...
    def publisher(
        ...
        opts_json = self.__convert_opts2json(
            preferred_only=preferred_only, inc_disabled=include_disabled
        )
        ret_json = self.__pkg(
            "publisher", pargs_json=publishers, opts_json=opts_json, mode=mode
        )
        # if not in single publisher mode.
        if (
            not publishers
            and "data" in ret_json
            and "publishers" in ret_json["data"]
        ):
            all_pubs = [dr[0] for dr in ret_json["data"]["publishers"]]
            ret_json = self.__pkg(
                "publisher", pargs_json=all_pubs, opts_json={}, mode=mode
            )
    ...
    def set_publisher(
        ...
        ssl_key=None,
        ssl_cert=None,
        approved_ca_certs=None,
        revoked_ca_certs=None,
        unset_ca_certs=None,
        origin_uri=None,
        reset_uuid=None,
        add_mirrors=None,
        ...
        add_origins=None,
        remove_origins=None,
        refresh_allowed=None,
        disable=None,
        sticky=None,
        repo_uri=None,
        proxy_uri=None,
        set_props=None,
        add_prop_values=None,
        remove_prop_values=None,
        unset_props=None,
        search_before=None,
        search_after=None,
        search_first=None,
    ...
    def unset_publisher(self, publishers=None, mode=None):
        ret_json = self.__pkg(
            "unset-publisher", pargs_json=publishers, opts_json=None, mode=mode
        )
        return self.__handle_error(ret_json)
