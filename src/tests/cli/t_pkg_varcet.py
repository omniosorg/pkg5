...
class TestPkgVarcet(pkg5unittest.SingleDepotTestCase):
    ...
    pkg_user_facet = """
            ...
            add user username=root password=9EIfTNBp9elws uid=0 group=root homedir=/root login-shell=/usr/bin/bash ftpuser=false group-list=other group-list=bin group-list=sys group-list=adm
...
"""
    ...
    def test_group_var(self):
        ...
        # create an image which includes the variant to be tested
