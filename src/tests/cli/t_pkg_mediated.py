...
class TestPkgMediated(pkg5unittest.SingleDepotTestCase):
        ...
        pkg_python = """
            ...
            add file tmp/foopyus path=/usr/bin/python3.10-unladen-swallow owner=root group=bin mode=0555
            add link path=/usr/bin/python target=python3.10-unladen-swallow mediator=python mediator-version=3.5 mediator-implementation=unladen-swallow@3.5
            close """
...
""")
                ...
                check_target(gen_python_links(), "python3.10-unladen-swallow")
                self.__assert_mediation_matches("""\
